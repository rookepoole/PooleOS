...
def valid_markers() -> list[str]:
    ...
    return [
        ...
        "POOLEOS:KERNEL:ENTRY PASS contract=PKENTRY1 transfer_contract=PKXFER1 build=PKBUILD1-CYCLE177-N12-EX-HLD-V001-0000000001 entry_count=1 serial=present",
...
class NativeKernelTransferTests(unittest.TestCase):
    ...
    def test_profile_revalidation_and_authority_mutations_reject(self) -> None:
        cases = (
            (25, "build=PKBUILD1-CYCLE177-N12-EX-HLD-V001-0000000001", "build=PKBUILD1-CYCLE168-N12-AP-OWN-V002-0000000001"),
