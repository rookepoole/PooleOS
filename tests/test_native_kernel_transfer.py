...
def valid_markers() -> list[str]:
    return [
        ...
        "POOLEOS:KERNEL:ENTRY PASS contract=PKENTRY1 transfer_contract=PKXFER1 build=PKBUILD1-CYCLE138-N8-SMP-IPI-V001-00100000000 entry_count=1 serial=present",
