...
def valid_markers() -> list[str]:
    return [
        ...
        "POOLEBOOT/0.1 KERNEL_BINDING PASS version=1 file_bytes=204800 image_bytes=262144 sha256_prefix=8DE68D5A5F9D71DB path=manifest",
        "POOLEBOOT/0.1 KERNEL_FILE PASS bytes=204800 path=manifest_development",
        "POOLEBOOT/0.1 KERNEL_LOAD PASS image_bytes=262144 pages=64 entry_offset=32768 relocations=472 files_closed=12 pools_freed=11 fnv1a64=0143AB584E4778BC",
        "POOLEBOOT/0.1 ARTIFACT_SET PASS contract=PBART1 count=6 file_bytes=8761 pages=6 roles=2-7 fnv1a64=4E185B5EBFA76700 retained=1 signatures=0 measured=0",
        "POOLEBOOT/0.1 INNER_SET PASS proof=N5-INNER-LIVE-PARSE-001 artifacts=6 parsers=6 bindings=6 denials=6 file_bytes=8761 payload_bytes=8185 sha256=E80E88314DD131BF5D3DE61C01CD0DF91A4087555BEBE60003053F4A9A64DCFB retained=1 authority_grants=0 actions=0 state_writes=0 hardware_observations=0",
        "POOLEBOOT/0.1 TRUST_STATE DENY contract=PBTRUST1 policy_bytes=320 state_bytes=256 bindings=14 denials=1 denial=pbtrust_policy_unsigned policy_sha256=8B7B117487C88AFEA996119C37AC4CD0A0F0F00DE3FB8981ED9AADE1EA90996A state_sha256=7484ECC21DD22600E40A24D42F41175C6E09CFA9CD53561C90B6B7312D9FBFF6 source=esp_candidate auth=missing monotonic=missing signatures=0 authority_grants=0 state_writes=0",
        "POOLEBOOT/0.1 GOP PASS width=1280 height=800 stride=1280 mode=0 format=BGR",
        "POOLEBOOT/0.1 FRAME READY",
        "POOLEBOOT/0.1 KERNEL_MAP_PLAN PASS contract=PKMAP2 mappings=4 kernel_pages=64 ro=13 rx=37 rw=14 wx=0 pml4=511 pdpt=510 pd=0 pt=0 leaf_fnv1a64=3ADD1DF308ADF621",
        "POOLEBOOT/0.1 KERNEL_MAP_ACTIVE PASS table_pages=4 kernel_pages=64 physical_bits=40 mapped_fnv1a64=0143AB584E4778BC framebuffer=preserved cache_signature=00 first_page_bytes=2097152 last_page_bytes=2097152",
        "POOLEBOOT/0.1 KERNEL_MAP_RETAIN PASS table_pages=4 stack_pages=14 handoff_pages=256 guards=2 total_pages=334 stack_pt=65 handoff_pt=80 kernel_phys=000000001DD8B000 root=000000001DE49000 stack_phys=000000001DE4D000 stack_top=FFFFFFFF8004F000 handoff_phys=000000001DAE9000 handoff_virt=FFFFFFFF80050000 retained_fnv1a64=3AC5BF39371D59E7 original_cr3=restored firmware_calls_while_active=0",
        "POOLEBOOT/0.1 PBP1_FINAL PASS bytes=5048 records=4 memory_entries=97 framebuffer=1 artifacts=10 descriptor_bytes=48 exit_attempts=1 message_crc32=B85714CD fnv1a64=FB23E36CD8D71B95 state=boot_services_exited bytes_unchanged=1",
        ...
        "POOLEOS:KERNEL:ENTRY PASS contract=PKENTRY1 transfer_contract=PKXFER1 build=PKBUILD1-CYCLE126-N9-VM-001 entry_count=1 serial=present",
