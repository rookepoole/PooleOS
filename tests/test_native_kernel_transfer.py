...
def valid_markers() -> list[str]:
    ...
    return [
        ...
        "POOLEBOOT/0.1 KERNEL_LOAD PASS image_bytes=602112 pages=147 entry_offset=40960 relocations=1321 files_closed=12 pools_freed=11 fnv1a64=0D60A27A4D9E7F55",
        ...
        "POOLEBOOT/0.1 KERNEL_MAP_ACTIVE PASS table_pages=5 kernel_pages=147 physical_bits=40 mapped_fnv1a64=0D60A27A4D9E7F55 framebuffer=preserved cache_signature=00 first_page_bytes=2097152 last_page_bytes=2097152",
