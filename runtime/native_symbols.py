...
CANONICAL_IMAGE_BYTES: Final = 458_752
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "214F32214494E632063238337551C355BFED150B9B49846DB8A927584B8E47F0"
CANONICAL_LOADED_SHA256: Final = "15108E8D74F333F734A4220DA2AB334909C93C2214E0FB4A31F4386D6E552716"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE137-N8-SMP-RUNTIME-V001-0010000"
CANONICAL_BUILD_ID_SHA256: Final = "08CCE6FEF7596A57E23424869C0691B7267CC31ED4A0FA05340FCEA2ED9765D8"
CANONICAL_DEBUG_SHA256: Final = "D47A6786E58508145B7BE309A7AC831CCD466BE52D1EB79652F0B82CE456FF36"
CANONICAL_DEBUG_BYTES: Final = 5_298_896
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "321D641FBD6A2517B7D2E669C193AA95B353F405005AF522EC2061FAAF690BEF"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x4F000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x58000, 0xC000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x64000, 0xC000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x1BD86, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x1BE4C, 0xA36C, "poole_kernel_rust_entry"),
    )
