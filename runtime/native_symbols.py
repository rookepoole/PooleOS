...
CANONICAL_IMAGE_BYTES: Final = 364_544
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "2ACD4A5EF30CA1A4A22711FD31E2A259A5C87D97BCE7FB1BF49A3488B3FC02B2"
CANONICAL_LOADED_SHA256: Final = "0E36F523BE29337E5CA607D94E8DB58313194032B4FCAA8C30235FA58C3C7F7F"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE135-N8-IRQ-TIMER-V01-0010000"
CANONICAL_BUILD_ID_SHA256: Final = "56C91D31FC283E35218E5A4BA3C6BB29A68497E7A72A36036A20CF4699810689"
CANONICAL_DEBUG_SHA256: Final = "58F2AC2FC538D3AFFA2C83CA3ADA2E8D58B3ADD4F08771F6A6522C58ACE35C49"
CANONICAL_DEBUG_BYTES: Final = 4_908_504
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "A3454D62C453F6D27CD0CCDC8493139C6387575CA033220A4F69A09DAB024E9B"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x3D000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x46000, 0x9000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x4F000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x17AEB, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x17BB1, 0x8BAA, "poole_kernel_rust_entry"),
    )
