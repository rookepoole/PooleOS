...
CANONICAL_FILE_SHA256: Final = "F449D0E037571345A40162DC9A943A2FA01F1195F21C239C8D8F1A85D39CA06E"
CANONICAL_LOADED_SHA256: Final = "4B740D1FCDFE87EB10F20AA55B639555E2EBD01FBC46E418E680EE076CF1F221"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE125-N9-PMM-001"
CANONICAL_BUILD_ID_SHA256: Final = "2FEB029164781855CDA8683E9C41C109C9CDB86CAE19B097E33F6CDBE27172EF"
CANONICAL_DEBUG_SHA256: Final = "AA30A8ABA90A4A77FF4A2FC4DFD998EE4B8240C5FAF809977B3474A0DD151E60"
CANONICAL_DEBUG_BYTES: Final = 3_719_976
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "2EDD5B0AD9EAB7B2BC87625AA1FAEB91FA710944EAA553CDD8F507FD56E333DA"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x8000, 0x22000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x2A000, 0x5000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x2F000, 0x11000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x98FE, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x99C4, 14813, "poole_kernel_rust_entry"),
    )
