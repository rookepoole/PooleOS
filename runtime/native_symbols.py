...
CANONICAL_IMAGE_BYTES: Final = 196_608
CANONICAL_ENTRY_OFFSET: Final = 0x4000
CANONICAL_FILE_SHA256: Final = "BF1176019E9E4AF1C588898F565A6B1F66737517C2D3CA804510C4B0AC1B2E9D"
CANONICAL_LOADED_SHA256: Final = "AE10F03BA413BB6D31EE562757EF16E898109F587D40A3AB42E90CF813FCB0D1"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE101-N6-KENTRY-001"
CANONICAL_BUILD_ID_SHA256: Final = "CFE45F8D2BDECBE3DFF3584ADBFCFE4C69ABB96D8167BE896E98886AEF1D482B"
CANONICAL_DEBUG_SHA256: Final = "939CD1C036064DB0510A3108EC71BCF9210AF5CFFDDF9C44D148F4CC01B82CD7"
CANONICAL_DEBUG_BYTES: Final = 1_018_640
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "69F3CFAF14D49560212E7E825E275A36D80F739F0EDFC636AD81F2CDF2AB08B6"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        Segment(1, SEGMENT_RODATA, SEGMENT_READ, 0, 0x4000),
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x4000, 0x1C000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x20000, 0x2000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x22000, 0xE000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        Symbol(1, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_ENTRY, 0x4000, 56, "poole_kernel_entry"),
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x422A, 190, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x42E8, 850, "poole_kernel_rust_entry"),
    )
...
def make_golden_vectors() -> dict[str, Any]:
    ...
    for vector_id, purpose, data in definitions:
        bundle = parse(data)
        offsets = {
            "PSYM1-CANONICAL": (0x3FFF, 0x4000, 0x4037, 0x4038, 0x422A, 0x42E8, 0x4639),
