...
CANONICAL_FILE_SHA256: Final = "5CBB39B4BFF9A23E8D65E3115FE536D4CDB13EAA372E8DAA5071F1530210132E"
CANONICAL_LOADED_SHA256: Final = "2E031002E303B22C9836F73636A6B6DF4061462293B62DA383A62060A386AA96"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE117-N5-REVALIDATE-001"
CANONICAL_BUILD_ID_SHA256: Final = "4F29BB22D36F289A892E84DAB4C5C0C90093A61D91844E47CAE35F0A23EFCE48"
CANONICAL_DEBUG_SHA256: Final = "BBCCFB73249138C431F1262D0533297CC8B66614D560E2A1D531DD7EB15E2F1F"
CANONICAL_DEBUG_BYTES: Final = 3_428_512
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "AA05393FA6A1C33FFAD7AC143FF1E6F16391159E8B10222ECA9E0B1660ED34ED"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x8000, 0x20000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x28000, 0x4000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x2C000, 0x14000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        Symbol(1, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_ENTRY, 0x8000, 56, "poole_kernel_entry"),
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x822A, 190, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x82E8, 1085, "poole_kernel_rust_entry"),
    )
...
def make_golden_vectors() -> dict[str, Any]:
    ...
    for vector_id, purpose, data in definitions:
        bundle = parse(data)
        offsets = {
            "PSYM1-CANONICAL": (0x7FFF, 0x8000, 0x8037, 0x8038, 0x822A, 0x82E8, 0x8724),
