...
CANONICAL_IMAGE_BYTES: Final = 311_296
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "30E414826D7DF588C07A66032423DCD6AA8C47B0E6CCFC3D6686BC9224AFB947"
CANONICAL_LOADED_SHA256: Final = "B366FACA80AF826BE3969EA251B059AC40EC6266917D4E0BC97BEBB725F4EB65"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE131-N9-PMM-GROWTH-001"
CANONICAL_BUILD_ID_SHA256: Final = "CFF0410E640559D08F7D8449BAB52175BB4CBD076B2A1DD50C8E23DA3FBA5C4A"
CANONICAL_DEBUG_SHA256: Final = "1F4857685D8BD18293448FAC63A297D7378504A38B17F266471AB70D66DB05FC"
CANONICAL_DEBUG_BYTES: Final = 4_518_616
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "530C2946B6B6527406DD8537F5B3C7B84BD6FC78E096570F797C11C0418464D2"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x32000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x3B000, 0x7000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x42000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x129A7, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x12A6D, 0x65A3, "poole_kernel_rust_entry"),
    )
