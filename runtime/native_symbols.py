...
CANONICAL_FILE_SHA256: Final = "9C23236E85A6D2C7AEEFDA12F3CEC202DC3BF34B89D9CEAEEBB7037A079DA168"
CANONICAL_LOADED_SHA256: Final = "A8A26DF55F902FB8DB7F07C3B953703734AA7EC2C410C1548B3297CECFA6853A"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE145-N12-SCHED-SMP-V0001-000001"
CANONICAL_BUILD_ID_SHA256: Final = "59D37099F7C948BB754AB137FDC4D5A41ED2F991F37A0583655EDC101417C219"
CANONICAL_DEBUG_SHA256: Final = "AF7A1AD3A3111AEF73E9E7737EDAD156E12F626DA6550BC9EBD01507F08334C3"
CANONICAL_DEBUG_BYTES: Final = 6_199_712
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "1EADF3567C14B6024A000D83E5812385614A83FF91968AB867F8A2C64793CEB5"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x5C000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x66000, 0xE000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x74000, 0x14000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x255C7, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x2568D, 0xF104, "poole_kernel_rust_entry"),
    )
