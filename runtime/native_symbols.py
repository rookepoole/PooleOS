...
CANONICAL_IMAGE_BYTES: Final = 319_488
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "CDF33067B2421550BB03A4796FF9A92AE54D40B2575188632BF2C208449B882E"
CANONICAL_LOADED_SHA256: Final = "69807BD8AF2374B1CE2849A615A249654BC90A25BE9F71834081D0B75F832D23"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE132-N9-PMM-GROWTH-AUTOMATION-001"
CANONICAL_BUILD_ID_SHA256: Final = "59246B6199BCEE11D04DD45564C050C0EFEF857915A29591349D65589573454D"
CANONICAL_DEBUG_SHA256: Final = "AD1D40AEEFC3AF4B210F6E288E5F2092478C09F23E7C12BB2AFB94D536FC49E8"
CANONICAL_DEBUG_BYTES: Final = 4_570_744
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "5EE0684A31EB5BF95EC4138AF76CA91852F730E907047EB0F8984160254E2E73"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        Segment(1, SEGMENT_RODATA, SEGMENT_READ, 0, 0x9000),
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x34000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x3D000, 0x7000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x44000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        Symbol(1, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_ENTRY, 0x9000, 71, "poole_kernel_entry"),
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x13800, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x138C6, 0x68E4, "poole_kernel_rust_entry"),
    )
