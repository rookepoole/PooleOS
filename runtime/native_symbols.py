...
CANONICAL_IMAGE_BYTES: Final = 286_720
CANONICAL_ENTRY_OFFSET: Final = 0x8000
CANONICAL_FILE_SHA256: Final = "20BCE1C7501BC2344A6D7505BCDA749D9B2738A8435255D0EC2EF5A3E177CC4C"
CANONICAL_LOADED_SHA256: Final = "BCBE6AEB56B5DC5ADD0B8A40A131DE73B80E6C0996FB5232673D089533366EDC"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE130-N9-PMM-RECLAIM-001"
CANONICAL_BUILD_ID_SHA256: Final = "2F67CF7F9A1F4DB3218D43F50F099F30151DECDDE0D0D0E9D03EEA446105EBD6"
CANONICAL_DEBUG_SHA256: Final = "4FB716646D93E9447D2F67C08E0908B0F045EBEAFE8F16AB1E1037AC03B65BE2"
CANONICAL_DEBUG_BYTES: Final = 4_398_984
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "20F2C57DA4F5505DBE2752C73126633E5F77931A9BB8137A541B1A02E22D458F"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x8000, 0x2E000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x36000, 0x6000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x3C000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x1002B, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x100F1, 0x5B0C, "poole_kernel_rust_entry"),
    )
