...
CANONICAL_FILE_SHA256: Final = "5533347F0DA41B0F08B4E0ADF643379706BE548B5486D49C57960FEFE799FE93"
CANONICAL_LOADED_SHA256: Final = "6692050877B4C6D0B3546F8AEBF3EB0CA3051059C96A44725523E87EFAC1BC4B"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE127-N9-VM-ACTIVE-001"
CANONICAL_BUILD_ID_SHA256: Final = "FD75DE0F22AA9E4BCBBCD2ECD1149CE50E65EEB2F2A25BE4698120D1522595A1"
CANONICAL_DEBUG_SHA256: Final = "B918E4F44A98297B36F272B2EB75D822C3F97676A966F70A8BD0E1CC86118EA0"
CANONICAL_DEBUG_BYTES: Final = 4_128_648
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "13AC0857560DD415F41FCC36E64BD23D4F37E2B9C493493AF50AF00C361EDCD2"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x8000, 0x28000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x30000, 0x6000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x36000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0xD70E, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0xD7D4, 0x4559, "poole_kernel_rust_entry"),
    )
