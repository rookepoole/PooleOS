...
CANONICAL_IMAGE_BYTES: Final = 339_968
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "D9EF9B10B56BF779B155BD18DE55853874CCC032D2A3E5E7841B918F08CDE1F2"
CANONICAL_LOADED_SHA256: Final = "F33F0BD1A696D764EEEF0E4B3148F1BF0BE4D9BBA77CF677737D7992DF7E452F"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE133-N9-PMM-ACPI-CONSUMER-001"
CANONICAL_BUILD_ID_SHA256: Final = "C391CE6230E913606C9253D778ED94823C2663028C2CAE334E8E5B9EB4AE5C56"
CANONICAL_DEBUG_SHA256: Final = "8781F1FAEBBAFAB68D1DA918822D2DE24F42F52EF2F2E954A6B461194132D200"
CANONICAL_DEBUG_BYTES: Final = 4_673_408
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "3E5D4E98E08539F2487CB35ADE8974C2486C77531151CE94DAC633EC20F0CAF8"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x38000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x41000, 0x8000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x49000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x15106, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x151CC, 0x75F5, "poole_kernel_rust_entry"),
    )
