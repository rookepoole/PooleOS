...
CANONICAL_IMAGE_BYTES: Final = 270_336
CANONICAL_ENTRY_OFFSET: Final = 0x8000
CANONICAL_FILE_SHA256: Final = "06D36FAF5531509097CD03819390AC744DCFD2BD9FB64D1E6F6710DD7796776E"
CANONICAL_LOADED_SHA256: Final = "EAB98FBFE9EFD8EB35DDD76AA21C2E13DF2BABB5A1D93904C9B760ABC532C47D"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE128-N9-PMM-SCRUB-001"
CANONICAL_BUILD_ID_SHA256: Final = "81EB2739BF1C282DE9DB4E202E0F12E62DB96CB9098DD3FB9728CA3B15885352"
CANONICAL_DEBUG_SHA256: Final = "F530DE867A5A04CAE3B21027EE46D2B87FC3B6D648B36926A75093AA73EF52DE"
CANONICAL_DEBUG_BYTES: Final = 4_207_912
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "4D27EAC3B4E9ACFFB3089B32C76C4AD0D5C487DC010E969E3E8452D8D1399387"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x8000, 0x2A000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x32000, 0x6000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x38000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0xE574, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0xE63A, 0x4DC2, "poole_kernel_rust_entry"),
    )
