...
CANONICAL_IMAGE_BYTES: Final = 376_832
CANONICAL_ENTRY_OFFSET: Final = 0x9000
CANONICAL_FILE_SHA256: Final = "6596CB332EB24813089F95A00AC979C892C47235943CB0E73E3979ED9901B725"
CANONICAL_LOADED_SHA256: Final = "49F6795CAD45E1D0A490198C7A8A86EF3CE5046ABAFDEDFB628CB387D3EB45D7"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE136-N8-SMP-FIRST-AP-V01-0010000"
CANONICAL_BUILD_ID_SHA256: Final = "C6B721E5AC26D12BE710329E6B45C30A737F779CE0326005F7FE9856332D0841"
CANONICAL_DEBUG_SHA256: Final = "E0D818B5C03345AA855E450EB8D2E1CFBBDC928E172834BCC11E1D88E3D646D0"
CANONICAL_DEBUG_BYTES: Final = 5_075_616
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "617CA27F81772C0DA9D138B8FB4B19322283EC59D6E9D18AFD4C5C6AC69FBE1E"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0x9000, 0x40000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x49000, 0x9000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x52000, 0xA000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x19721, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x197E7, 0x942B, "poole_kernel_rust_entry"),
    )
