...
CANONICAL_FILE_SHA256: Final = "D11591395FDD8CD7BEEFA0D847A5C99EB133ED15F8DCDDE3392BFA499DCEDC33"
CANONICAL_LOADED_SHA256: Final = "779F6D34049C26ACA86A61A46DB3C9A44A850556C6656E7E057900D6A9D71FD6"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE146-N12-SCHED-APW-V0001-000001"
CANONICAL_BUILD_ID_SHA256: Final = "900C7B31588886B9A1E9DA985289FE3D1E74C826841F5327F0D65E09532E0C6D"
CANONICAL_DEBUG_SHA256: Final = "46748EC3746FCDB5E617EDBC6E4F24C4EB8D42AE978EEFFFC7A2DE22BD05EFF4"
CANONICAL_DEBUG_BYTES: Final = 6_390_008
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "46367C48E2E28E6F979E7DF0738AA48E832068A6569A90189F765AF0880B95A7"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x5F000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x69000, 0xD000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x76000, 0x12000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x265DC, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x266A2, 0xFEE8, "poole_kernel_rust_entry"),
    )
