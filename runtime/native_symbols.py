...
CANONICAL_IMAGE_BYTES: Final = 507_904
CANONICAL_ENTRY_OFFSET: Final = 0xA000
CANONICAL_FILE_SHA256: Final = "AFED4AF858404D83CD77215C118F8478C88E91BDDC0F0B1ABAC3C9324B6ED602"
CANONICAL_LOADED_SHA256: Final = "D290EB079DDFAD7191A7097B9BA6649F48E2ACF33104E57E5654B7A825B6A6D4"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE142-N12-SCHED-FOUND-V001-00001"
CANONICAL_BUILD_ID_SHA256: Final = "DDD187B0C8EFEEFF05BC256FECFAB1899588162BE2E86FE5E5F81DAED9D69B1C"
CANONICAL_DEBUG_SHA256: Final = "E460C4C8CF03A3FEFC3E591B9D9FE2452D3DA67EF0F6774078405342810E4F75"
CANONICAL_DEBUG_BYTES: Final = 5_727_496
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "7475E192EC4FB442A19D705EE93300BC4BAAA48B67F08C950BA1AA9F1C8EFE28"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x52000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x5C000, 0xC000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x68000, 0x14000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x231A7, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x2326D, 0xC1F6, "poole_kernel_rust_entry"),
    )
