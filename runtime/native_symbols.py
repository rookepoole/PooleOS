...
CANONICAL_IMAGE_BYTES: Final = 589_824
CANONICAL_ENTRY_OFFSET: Final = 0xA000
CANONICAL_FILE_SHA256: Final = "18EDADA10E141DBADA8C95C1C0B3454696122C5E96C528F45E0AECE6ADD2F07D"
CANONICAL_LOADED_SHA256: Final = "0F04D39C2F9E9D06FD732A72D1991E6EC03514ECDF8295C246DAE91DC0A88653"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE158-N12-RETAIN-V002-0000000001"
CANONICAL_BUILD_ID_SHA256: Final = "0C724404C83C1760B18F1B37DF42A0F7551AF234EA421A0753447E4E21FF02E2"
CANONICAL_DEBUG_SHA256: Final = "424FA13AD55F709C3C5F30E3A246B0F694F4EECD688F598F5B7214BE2FD137E5"
CANONICAL_DEBUG_BYTES: Final = 6_875_136
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "E9FAA51A5273D96872AC8F96635806217D86CC8AE152D002FA5DAF8CA5D319DF"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x67000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x71000, 0xD000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x7E000, 0x12000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x294D3, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x29599, 70_594, "poole_kernel_rust_entry"),
    )
