...
CANONICAL_IMAGE_BYTES: Final = 557_056
CANONICAL_ENTRY_OFFSET: Final = 0xA000
CANONICAL_FILE_SHA256: Final = "A5DE1DBD2ECA9243D90C2EAA2BEDCAC4B0FCC5E4A4779073E398C6722F30B943"
CANONICAL_LOADED_SHA256: Final = "DF156985AFD2115BA75AB152CC440485656461957208B8BC3C75AB43C28CFB5A"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE143-N12-SCHED-PREEMPT-V01-0001"
CANONICAL_BUILD_ID_SHA256: Final = "844FF37A2AB5DDF117D35E13A01756B61E1C88221A5F127CA7B2205546DE7E66"
CANONICAL_DEBUG_SHA256: Final = "B38362BB2A56ABC42BAC035A9CCEEF3BE0439D0C6EA0C49E1AFD3ABB8F7CA5B9"
CANONICAL_DEBUG_BYTES: Final = 5_873_592
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "F4A735262005EBD3E5361EBDFA22183AC7A3F56E15F865BC7DF3967A916E73DD"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x56000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x60000, 0xC000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x6C000, 0x1C000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x23C82, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x23D48, 0xD3AC, "poole_kernel_rust_entry"),
    )
