...
CANONICAL_FILE_SHA256: Final = "8D1C219B4B6D8FEFE3B325F3A59DF904F1D971686A4A6537D73825A1B6F56FD2"
CANONICAL_LOADED_SHA256: Final = "A13BAA5BED17F451861DA700662D5CEC1DB39F9344873A02DA8562A1DAF24D20"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE119-N7-TRAP-001"
CANONICAL_BUILD_ID_SHA256: Final = "AD783383CD6DB949335ABCA2EA3F9EBAC6DE9DB5690C81C086C7454C192A1A32"
CANONICAL_DEBUG_SHA256: Final = "7A2946F86B3A135C2BAC080842FE3CFBF84981ED412BF4DE460EF8EB093CAF4B"
CANONICAL_DEBUG_BYTES: Final = 3_492_624
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "1A68F2E8E3414A4B97A57853D9178F5A545BA75318ED9E9C87F64682AFC06DBF"
)
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x87AF, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x8875, 3714, "poole_kernel_rust_entry"),
    )
...
def make_golden_vectors() -> dict[str, Any]:
    ...
    for vector_id, purpose, data in definitions:
        bundle = parse(data)
        offsets = {
            "PSYM1-CANONICAL": (0x7FFF, 0x8000, 0x8046, 0x8047, 0x87AF, 0x8875, 0x96F6),
