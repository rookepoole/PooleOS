...
CANONICAL_FILE_SHA256: Final = "21DCC577077DEC8CF26764CE83BAAB89DFD43B750DA75F19E12E8F3A58E13B40"
CANONICAL_LOADED_SHA256: Final = "5FC4B8BD942A35842B353F448CAD26E0DE874BD0F0CBE7911816FF4175133F66"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE120-N7-CPU-POLICY-001"
CANONICAL_BUILD_ID_SHA256: Final = "D75974AD6EA8586ADFF7AEE7B48EC4C173023843AE820C801366C3B3308BA014"
CANONICAL_DEBUG_SHA256: Final = "94CC929D60DD704DA165B62B71DD9E357C9CA11691987A7D6E8B187445ADDF9C"
CANONICAL_DEBUG_BYTES: Final = 3_541_696
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "07D395013D94A941BCA3E7FE4957459EFA0FB3687E39ACCDC628624A1F83B1CA"
)
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x8E47, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x8F0D, 6529, "poole_kernel_rust_entry"),
    )
...
def make_golden_vectors() -> dict[str, Any]:
    ...
    for vector_id, purpose, data in definitions:
        bundle = parse(data)
        offsets = {
            "PSYM1-CANONICAL": (0x7FFF, 0x8000, 0x8046, 0x8047, 0x8E47, 0x8F0D, 0xA88D),
