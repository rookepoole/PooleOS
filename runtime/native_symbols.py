...
CANONICAL_IMAGE_BYTES: Final = 585_728
CANONICAL_ENTRY_OFFSET: Final = 0xA000
CANONICAL_FILE_SHA256: Final = "FCE5C1F2478651D010A2F2781B80494FD0D9721880D33CE8C66A499B35C8DAB6"
CANONICAL_LOADED_SHA256: Final = "684F5A98FF8D3826491D41172D5F62D55E8DB8E8074CABC9E4AD63AE6822D7C4"
CANONICAL_BUILD_ID: Final = "PKBUILD1-CYCLE147-N12-SMP-PREEMPT-V0001-0001"
CANONICAL_BUILD_ID_SHA256: Final = "3494A7C72082E693F443C4233A03D34CFE33C046185E71C8C149F058341C5DCD"
CANONICAL_DEBUG_SHA256: Final = "CB00D8A0181AEB81D70FE2892BBE41B5DD99D31F445874DED144B50CD59C327C"
CANONICAL_DEBUG_BYTES: Final = 6_560_408
CANONICAL_SOURCE_MANIFEST_SHA256: Final = (
    "1FDCC4B6158FADDF4D6BB1AAFCB475047B400B1EA9EF75557FA59A32D30E0220"
)
...
def canonical_segments() -> tuple[Segment, ...]:
    return (
        ...
        Segment(2, SEGMENT_TEXT, SEGMENT_READ | SEGMENT_EXECUTE, 0xA000, 0x66000),
        Segment(3, SEGMENT_RELRO_DATA, SEGMENT_READ | SEGMENT_RELRO, 0x70000, 0xD000),
        Segment(4, SEGMENT_DATA_BSS, SEGMENT_READ | SEGMENT_WRITE, 0x7D000, 0x12000),
    )
...
def canonical_symbols() -> tuple[Symbol, ...]:
    ...
    return (
        ...
        Symbol(2, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public | SYMBOL_PANIC_SAFE, 0x27C6E, 198, "poole_kernel_emergency_panic"),
        Symbol(3, 2, SYMBOL_FUNCTION, BIND_GLOBAL, VISIBILITY_DEFAULT, PRIVACY_PUBLIC, public, 0x27D34, 0x10B15, "poole_kernel_rust_entry"),
    )
