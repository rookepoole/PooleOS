...
def readiness_contract_errors(readiness: dict[str, Any], root: Path) -> list[str]:
    ...
    expected_bindings = {
        ...
        "microcode_contract": "specs/native-microcode-contract.json",
        "microcode_readiness": "runs/native_microcode_readiness.json",
        "firmware_contract": "specs/native-firmware-contract.json",
