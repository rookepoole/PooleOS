...
STACK_GUARD_LOW_PAGE = 124
STACK_FIRST_PAGE = STACK_GUARD_LOW_PAGE + 1
STACK_PAGE_COUNT = 32
STACK_GUARD_HIGH_PAGE = STACK_FIRST_PAGE + STACK_PAGE_COUNT
HANDOFF_FIRST_PAGE = STACK_GUARD_HIGH_PAGE + 1
HANDOFF_PAGE_COUNT = 256
HANDOFF_CAPACITY_BYTES = HANDOFF_PAGE_COUNT * PAGE_SIZE
TEMPORARY_PAGE_INDEX = HANDOFF_FIRST_PAGE + HANDOFF_PAGE_COUNT
METADATA_GUARD_LOW_PAGE = TEMPORARY_PAGE_INDEX + 1
METADATA_FIRST_PAGE = METADATA_GUARD_LOW_PAGE + 1
METADATA_PAGE_COUNT = 5
METADATA_GUARD_HIGH_PAGE = METADATA_FIRST_PAGE + METADATA_PAGE_COUNT
LEDGER_A_GUARD_LOW_PAGE = METADATA_GUARD_HIGH_PAGE + 1
LEDGER_A_FIRST_PAGE = LEDGER_A_GUARD_LOW_PAGE + 1
LEDGER_A_PAGE_CAPACITY = 32
LEDGER_A_GUARD_HIGH_PAGE = LEDGER_A_FIRST_PAGE + LEDGER_A_PAGE_CAPACITY
LEDGER_B_GUARD_LOW_PAGE = LEDGER_A_GUARD_HIGH_PAGE + 1
LEDGER_B_FIRST_PAGE = LEDGER_B_GUARD_LOW_PAGE + 1
LEDGER_B_PAGE_CAPACITY = 32
LEDGER_B_GUARD_HIGH_PAGE = LEDGER_B_FIRST_PAGE + LEDGER_B_PAGE_CAPACITY
MMIO_GUARD_LOW_PAGE = LEDGER_B_GUARD_HIGH_PAGE + 1
LOCAL_APIC_PAGE = MMIO_GUARD_LOW_PAGE + 1
MMIO_GUARD_MIDDLE_PAGE = LOCAL_APIC_PAGE + 1
HPET_PAGE = MMIO_GUARD_MIDDLE_PAGE + 1
MMIO_GUARD_HIGH_PAGE = HPET_PAGE + 1
