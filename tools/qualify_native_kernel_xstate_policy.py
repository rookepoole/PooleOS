...
def _source_audit() -> dict[str, Any]:
    ...
    msr_write_start = source.index("unsafe fn write_msr", start, end)
    msr_write_end = source.index("unsafe fn read_efer", msr_write_start, end)
    segment = (source[start:msr_write_start] + source[msr_write_end:end]).lower()
