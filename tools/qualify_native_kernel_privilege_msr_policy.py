...
def _linked_machine_audit(toolchain_root: Path, temporary_root: Path) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    function_counts = {
        ...
        for name in (
            ...
            "PooleKernelLinked::arch::x86_64::prepare_scheduler_deferred_workers",
            "PooleKernelLinked::arch::x86_64::run_scheduler_preemption_launcher",
            "PooleKernelLinked::arch::x86_64::clear_scheduler_deferred_workers",
    ...
    expected_function_counts = {
        ...
        "PooleKernelLinked::arch::x86_64::prepare_scheduler_deferred_workers": {"rdmsr": 3, "wrmsr": 0},
        "PooleKernelLinked::arch::x86_64::run_scheduler_preemption_launcher": {"rdmsr": 6, "wrmsr": 0},
        "PooleKernelLinked::arch::x86_64::clear_scheduler_deferred_workers": {"rdmsr": 3, "wrmsr": 0},
    ...
    audit = {
        ...
        "pksched3_linked_rdmsr_count": 6,
        "result": "pass_linked_privileged_instruction_scope_with_pkirq1_pksmp1_pksmp2_pksmp3_pksched1_pksched2_and_pksched3_isolation",
    }
    return audit, tool
