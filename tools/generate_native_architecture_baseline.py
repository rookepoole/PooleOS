...
BOUND_SOURCE_PATHS = (
    ...
    "specs/governance-key-registration.schema.json",
    ...
    "specs/native-elf-loader-contract.schema.json",
    "specs/native-elf-loader-golden-vectors.json",
    "specs/native-elf-loader-golden-vectors.schema.json",
    "specs/native-elf-loader-readiness.schema.json",
    ...
    "specs/native-kernel-entry-readiness.schema.json",
    ...
    "specs/native-kernel-revalidation-readiness.schema.json",
