...
def check_native_kernel_scheduler_smp_readiness() -> CheckResult:
    from tools import pooleos_release_gate

    check = pooleos_release_gate.check_native_kernel_scheduler_smp_readiness()
    return CheckResult(
        name=check["name"],
        ok=check["ok"],
        detail=check["detail"],
...
def check_native_kernel_atomics_readiness() -> CheckResult:
    from tools import pooleos_release_gate
...
def check_native_kernel_locks_readiness() -> CheckResult:
    from tools import pooleos_release_gate
    ...
    checks.extend(
        check_required_files(
            [
                ...
                ROOT / "tools" / "qualify_native_kernel_atomics.py",
                ROOT / "tools" / "qualify_native_kernel_locks.py",
                ...
                ROOT / "runtime" / "native_kernel_atomics.py",
                ROOT / "runtime" / "native_kernel_locks.py",
                ...
                ROOT / "docs" / "native-kernel-atomics.md",
                ROOT / "docs" / "native-kernel-locks.md",
                ...
                ROOT / "native" / "kernel" / "src" / "bin" / "pkatom1_probe.rs",
                ROOT / "native" / "kernel" / "src" / "locks.rs",
                ROOT / "native" / "kernel" / "src" / "bin" / "pklock1_probe.rs",
                ...
                ROOT / "runs" / "native-kernel-locks-readiness.json",
                ...
                ROOT / "specs" / "native-kernel-atomics-contract.json",
                ROOT / "specs" / "native-kernel-atomics-contract.schema.json",
                ROOT / "specs" / "native-kernel-atomics-readiness.schema.json",
                ROOT / "specs" / "native-kernel-locks-contract.json",
                ROOT / "specs" / "native-kernel-locks-contract.schema.json",
                ROOT / "specs" / "native-kernel-locks-readiness.schema.json",
                ...
                ROOT / "tests" / "test_native_kernel_atomics.py",
                ROOT / "tests" / "test_native_kernel_locks.py",
