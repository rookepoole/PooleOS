...
PHASE_EVIDENCE = {
    ...
    "N12": [
        ...
        "ADD-N12-CONCURRENCY-RECLAMATION-001: Cycle 161 completes changed-image prerequisite replay; next mandatory active-root and execution-stack ownership, acknowledged cross-CPU quiescence, live timeout/offline/death/pressure/shutdown rollback, an independent oracle and exact-topology live evidence before closing N12.3",
    ],
...
PHASE_GAPS = {
    ...
    "N36": ["No native system, power-loss, hardware, accessibility, soak, or external security suite exists. ADD-N36-RECEIPT-COVERAGE-001 requires a per-profile recorded-evidence audit and malformed/missing/duplicate/substitution controls through validators and release gates; Cycle 155 hardens PKTRAP1 and Cycle 160 hardens PKCPU1 internal consistency only. Cycle 161 validates calendar dates in two scheduler component validators only; shared schema pattern/format enforcement remains open. Other profiles, authentication, independent builders and target execution remain under review"],
    ...
    return {
        ...
        "baseline": {
            ...
            "native_consistency_release_gate": {
                ...
                "production_ready": False,
                "native_promotion_role": "qualified_development_candidate_non_promoting",
                "qualification_status": "current_source_replay_passed_final_merge_checks_required",
                "passed_check_count_scope": "cycle161_pre_closeout_canonical_audit",
