...
PHASE_EVIDENCE = {
    ...
    "N6": [
        ...
        "runs/native_kernel_entry_readiness.json: 91/91 host tests, 2/2 exact clean linked and canonical builds, 43/43 hostile controls, 729 relative relocations, exact independent Rust/Python loaded bytes, and a current bound canonical SHA-256",
    ...
    "N9": [
        ...
        "runs/native-kernel-virtual-memory-readiness.json: 2/2 exact qemu64 QEMU/OVMF runs, 40 ordered markers, 46/46 hostile controls, 117,887 admitted pages in eleven sparse ranges with 12,878 hole pages, 237 direct leaf tables, one direct directory and 243 total table pages, coverage checksum 0x341CF729ADB26B52, 367,474 physical table writes, 950,234 temporary-PTE writes and invalidations, two CR3 writes, three active local invalidation receipts, one exact generation-retirement receipt, zero remote shootdowns, and zero signatures, authority, or actions",
