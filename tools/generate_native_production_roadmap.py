    ...
    return {
        ...
        "baseline": {
            ...
            "native_consistency_release_gate": {
                ...
                "qualification_status": "ap_ownership_qualified_changed_image_dependency_replay_pending",
...
def main() -> int:
    ...
    parser.add_argument("--test-count", type=int, default=933)
