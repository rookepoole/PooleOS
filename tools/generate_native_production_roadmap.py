    ...
    return {
        ...
        "baseline": {
            ...
            "native_consistency_release_gate": {
                ...
                "qualification_status": "native_dependencies_qualified_full_candidate_audit_pending",
                ...
                "current_ownership_qualification": {
                    ...
                    "live_receipt_scope": "cycle165_VM_replay_current_transfer_dependency",
...
def main() -> int:
    ...
    parser.add_argument("--test-count", type=int, default=924)
