    ...
    return {
        ...
        "baseline": {
            ...
            "native_consistency_release_gate": {
                ...
                "passed_check_count_scope": "historical_cycle162_pre_closeout_runtime_excluded_failed_audit",
...
def main() -> int:
    ...
    parser.add_argument("--test-count", type=int, default=920)
    parser.add_argument("--status-date", default="2026-09-08")
