    ...
    return {
        ...
        "baseline": {
            ...
            "native_consistency_release_gate": {
                ...
                "qualification_status": "boot_chain_qualified_downstream_dependency_replay_pending",
...
def main() -> int:
    ...
    parser.add_argument("--test-count", type=int, default=935)
