...
pub const TEMPORARY_MAP_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::TEMPORARY_PAGE_INDEX as u64 * PAGE_BYTES;
pub const TEMPORARY_MAP_END_EXCLUSIVE: u64 = TEMPORARY_MAP_START + PAGE_BYTES;
pub const METADATA_GUARD_LOW_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::METADATA_GUARD_LOW_PAGE as u64 * PAGE_BYTES;
pub const METADATA_MAP_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::METADATA_FIRST_PAGE as u64 * PAGE_BYTES;
pub const METADATA_MAP_END_EXCLUSIVE: u64 =
    METADATA_MAP_START + poole_kmap::METADATA_PAGE_COUNT as u64 * PAGE_BYTES;
pub const METADATA_GUARD_HIGH_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::METADATA_GUARD_HIGH_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_A_GUARD_LOW_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_A_GUARD_LOW_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_A_MAP_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_A_FIRST_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_A_GUARD_HIGH_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_A_GUARD_HIGH_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_B_GUARD_LOW_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_B_GUARD_LOW_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_B_MAP_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_B_FIRST_PAGE as u64 * PAGE_BYTES;
pub const LEDGER_B_GUARD_HIGH_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LEDGER_B_GUARD_HIGH_PAGE as u64 * PAGE_BYTES;
pub const MMIO_GUARD_LOW_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::MMIO_GUARD_LOW_PAGE as u64 * PAGE_BYTES;
pub const LOCAL_APIC_MAP_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::LOCAL_APIC_PAGE as u64 * PAGE_BYTES;
pub const MMIO_GUARD_MIDDLE_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::MMIO_GUARD_MIDDLE_PAGE as u64 * PAGE_BYTES;
pub const HPET_MAP_START: u64 = KERNEL_IMAGE_START + poole_kmap::HPET_PAGE as u64 * PAGE_BYTES;
pub const MMIO_GUARD_HIGH_START: u64 =
    KERNEL_IMAGE_START + poole_kmap::MMIO_GUARD_HIGH_PAGE as u64 * PAGE_BYTES;
