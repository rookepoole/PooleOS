...
pub const STACK_GUARD_LOW_PAGE: usize = 144;
...
pub const HANDOFF_FIRST_PAGE: usize = STACK_GUARD_HIGH_PAGE + 1;
...
pub const LEDGER_A_GUARD_LOW_PAGE: usize = METADATA_GUARD_HIGH_PAGE + 1;
pub const LEDGER_A_FIRST_PAGE: usize = LEDGER_A_GUARD_LOW_PAGE + 1;
pub const LEDGER_A_PAGE_CAPACITY: usize = 32;
pub const LEDGER_A_GUARD_HIGH_PAGE: usize = LEDGER_A_FIRST_PAGE + LEDGER_A_PAGE_CAPACITY;
pub const LEDGER_B_GUARD_LOW_PAGE: usize = LEDGER_A_GUARD_HIGH_PAGE + 1;
pub const LEDGER_B_FIRST_PAGE: usize = LEDGER_B_GUARD_LOW_PAGE + 1;
pub const LEDGER_B_PAGE_CAPACITY: usize = 32;
pub const LEDGER_B_GUARD_HIGH_PAGE: usize = LEDGER_B_FIRST_PAGE + LEDGER_B_PAGE_CAPACITY;
pub const MMIO_GUARD_LOW_PAGE: usize = LEDGER_B_GUARD_HIGH_PAGE + 1;
pub const LOCAL_APIC_PAGE: usize = MMIO_GUARD_LOW_PAGE + 1;
pub const MMIO_GUARD_MIDDLE_PAGE: usize = LOCAL_APIC_PAGE + 1;
pub const HPET_PAGE: usize = MMIO_GUARD_MIDDLE_PAGE + 1;
pub const MMIO_GUARD_HIGH_PAGE: usize = HPET_PAGE + 1;
...
mod tests {
    ...
    fn builds_retained_stack_guards_and_read_only_handoff() {
        ...
        assert_eq!(
            ...
            request().page_count + STACK_PAGE_COUNT as u32 + HANDOFF_PAGE_COUNT as u32
        );
