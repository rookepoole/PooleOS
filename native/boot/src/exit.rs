...
const DEVELOPMENT_TRAP_SCENARIO: u8 = if cfg!(feature = "development-trap-returning") {
    ...
    14
} else if cfg!(feature = "development-scheduler") {
    15
} else if cfg!(feature = "development-scheduler-preempt") {
    16
} else if cfg!(feature = "development-scheduler-deferred") {
    17
} else if cfg!(feature = "development-scheduler-smp") {
    18
