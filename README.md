...
- `models/tla/`, `docs/native-formal-models.md`, `tools/bootstrap_native_models.ps1`, and `tools/qualify_native_models.py`: boot-slot rollback and capability derivation/revocation models plus workspace-local deterministic reproduction.
